...
import { DEFAULT_BOT_DISPLAY_NAME, NOW4REAL_BOT_JWT_SUB } from "./constants.js";
...
export function resolveOutboundUser(params: any): { displayName: string; displayIcon?: string; jwtSub: string } {
